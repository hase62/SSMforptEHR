...
public class mainVARSSM {
	public static void main(String[] args) throws IOException {
		...
		if (args.length < argsLength) {
			System.err.println("java -jar VARSSM.jar <root> <data> <Structure> <id> <varssm.set> <output> <drug> <drug.z0> <drug structure> <Nu>");
			/* 
			 * /Users/takanorihasegawa/Dropbox/Program/java/input/SSM Input/WNT5A-test.txt NO 0 Set/varssm_simpletest.set NO NO NO NO
			 * /Users/takanorihasegawa/Dropbox/Program/java/input/SSM Input/PG.Obs.txt NO 0 Set/varssm_artificial.set Output/PG_1 Input/PG.Drug.txt Input/Z0.txt NO
			 * /Users/takanorihasegawa/Dropbox/Program/java/input/SSM Input/Muscle_mas5_Target_Normalization_Core.txt Input/Muscle_Core_Given.txt 0 Set/varssm_real.set Output Input/Muscle_DRN_0.5.txt Input/Z0.txt Input/Muscle_Core_GivenG.txt
			 * /Users/takanorihasegawa/Dropbox/Program/java/input/SSM Input/TSDA.MALE.txt NO 0 Set/varssm_hirosaki.set Output NO NO NO
			 * /Users/takanorihasegawa/Dropbox/Program/java/input/SSM Input/Influ.Patients.Log.Sparse.txt NO 0 Set/varssm_artificial.set Output Input/Influ.abs.rel.tempr.txt Input/Influ.abs.rel.tempr.Z0.txt NO
			 */
			System.exit(0);
		}
		...
		if(Setting.Drug) {
			...
			if(Setting.GivenRegulation) {
				try {
					...
					System.err.println("Please prepare <drug.txt> and <Z0.txt> including the concentration of drug");
					System.exit(0);
				}
			} else {
		...
		vsInference vINF = new vsInference(systemDimension, Setting, TimeSeriesData, Calculator, Sf, vSTO);
		
		System.out.println("Initial Loop - Fixing Upate ...... ");
		vINF.preparationPhase(5, 5);
		...
		for (int l = 0; l < vINF.vSet.maxLoop && (System.currentTimeMillis() - timeAtStart) < Setting.timer; l++) {
			...
			for (int i = 0; i < vINF.calculationOrder.length; i++) {
				System.out.println("Loop:" + l + " Row:" + i + " Start "+ (System.currentTimeMillis() - timeAtStart)/1000);
				vINF.Weight();
				vINF.updatingRow = i;
				vINF.initializeUpdatingRow(l == 0);
				vINF.setParameters();
				while(true) {
