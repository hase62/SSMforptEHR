...
public class mainstFilter {
	public static void main(String[] args) throws IOException {
		...
		if (args.length < argsLength) {
			...
			/* 
			 * /Users/takanorihasegawa/Dropbox/Program/java/input/SSM Input/Hirosaki_2017/TSDA.SCALE.tsda_full.FEMALE.40.75.txt NO 0 Set/varssm_hirosaki.set Output_Hirosaki_2017 Input/Hirosaki_2017/Z.zt_full.FEMALE.40.75.SCALE.txt.selected.txt NO NO
			 */
			System.exit(0);
		}
		...
		Setting.nu_kurtosis = TimeSeriesData.calc_kurtosis(Double.parseDouble(args[9]));
		...
		stInference vINF = new stInference(systemDimension, Setting, TimeSeriesData, Calculator, Sf, vSTO);
		...
		*/
		...
		if(Setting.testPredictionAbility == 0){
			...
			Calculator.write(pass2 + "/Delta" + "-" + ID + ".txt",vSTO.vPa.getDelta());
			Calculator.write(pass2 + "/LamInvR" + "-" + ID + ".txt",vSTO.vPa.getKurtosis_inv_R_t());
			Calculator.write(pass2 + "/Nu" + "-" + ID + ".txt",vSTO.vPa.getNu());
			Calculator.write(pass2 + "/s_m_t" + "-" + ID + ".txt",vSTO.vPa.getSkew_mean_t());
			Calculator.write(pass2 + "/k_m" + "-" + ID + ".txt",vSTO.vPa.getsetKurtosis_mean_t());
